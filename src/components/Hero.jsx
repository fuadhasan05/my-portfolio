...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Content container */}
      <div className="relative z-10 items-center justify-between gap-12 py-20">
        {/* Left text content */}
        <div className="text-center max-w-2xl">
          ...
          <div className="flex justify-center">
            <div className="w-62 h-62 rounded-xl shadow-lg border-2 overflow-hidden bg-gray-600 hover:bg-gray-300">
              <img
                src={img}
                alt="Fuad Hasan"
